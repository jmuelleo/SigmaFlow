...
class TrainingConfig:
    ...
    # EXP-102: Quellverteilung auf SO(3). Defaults reproduzieren EXP-100 exakt.
...
def parse_args() -> Namespace:
    ...
    # EXP-102 -- die einzige methodische Stellschraube dieses Experiments.
    parser.add_argument(
        "--source_mode",
        type=str,
        default=None,
        choices=["haar", "pocket_pca", "constant"],
        help="SO(3)-Quellverteilung. 'haar' ist die Kontrollbedingung und "
             "bit-identisch zu EXP-100.",
    )
    parser.add_argument(
        "--source_median_deg",
        type=float,
        default=None,
        help="Medianwinkel der Quelle zum Zentrum, in Grad. Haar hat 132.3. "
             "Aus arc/exp101_distance_audit.py zu setzen, nicht zu raten.",
    )
    # Hardware
    parser.add_argument(
        "--accelerator",
