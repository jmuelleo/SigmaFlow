...
#
#SBATCH --job-name=sigmaflow-sample-posebusters-full
...
# SigmaFlow_Development copy - without this, sampling would silently use
# the UNMODIFIED code and this checkpoint's variant-specific weights would
# be evaluated with the wrong architecture/loss assumptions baked into the
# rest of the pipeline (same fix as train_pdbbind_general_12h.sh).
